...
<head>
    ...
    <title>[Outdoor] AIAS - Bologna Onlus</title>

    <?php require_once "section/header.php" ?>
    <script type="text/javascript">
        var homeUrl = "JardinAusilioteca.zip";
    </script>
</head>
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Outdoor Area</h4>
                                <p class="category">Virtual tour of the outdoor area. The tour can be done in two ways: from an aerial perspective and as a virtual tour.</p>
                                <hr>
                                <div class="legend">
